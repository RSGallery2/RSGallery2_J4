...
This is a fork of the excellent work of [Nicholas K. Dionysopoulos](https://www.akeeba.com/) [Type hints project](https://github.com/nikosdion/joomlatypehints). Thank you very much for your work. This repo is only slightly extending his work to support the Rector efforts at [JRector](https://github.com/joomla-projects/jrector).
...
![Before applying any typehints. Boo!](https://raw.githubusercontent.com/joomla-projects/typehints/master/docs/before.png)

**After**

![Code hinting, type checks and deprecated warnings? Check!](https://raw.githubusercontent.com/joomla-projects/typehints/master/docs/after_01.png)

![Code completion and method hints? Check!](https://raw.githubusercontent.com/joomla-projects/typehints/master/docs/after_02.png)
...
```bash
git clone https://github.com/joomla-projects/typehints.git
cd joomlatypehints
composer install
```
