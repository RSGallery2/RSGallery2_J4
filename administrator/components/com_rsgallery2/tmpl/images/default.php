...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_rsgallery2&task=images.saveOrderAjax&tmpl=component&' . Session::getFormToken(
        ) . '=1';
                ...
                <?php
					...
					<table class="table" id="galleryList">
                        ...
                        foreach ($this->items as $i => $item) : ?>
                            ...
                            $editLink        = Route::_(
                                'index.php?option=com_rsgallery2&task=image.edit&id=' . $item->id,
                            );
                            $editGalleryLink = Route::_(
                                "index.php?option=com_rsgallery2&task=gallery.edit&id=" . $item->gallery_id,
                            );
...
//	                                $src = $this->ImagePathJ3x->getThumbUrl($item->name);
                            ...
                            echo $item->gallery_id; ?>" item-id="<?php
                            echo $item->id ?>">
