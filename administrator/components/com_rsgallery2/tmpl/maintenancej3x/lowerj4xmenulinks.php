        ...
        <div class="flex-fill">
            <div id="j-main-container" class="j-main-container">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <h3 class="card-title"><?php echo Text::_('COM_RSGALLERY2_DO_LOWER_MENU_LINKS', true); ?></h3>
