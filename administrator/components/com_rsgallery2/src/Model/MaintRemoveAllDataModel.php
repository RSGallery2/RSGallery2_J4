	...
	public function removeDataInTables()
	{
		...
		try
		{
			...
			if (false) {
				...
				[$isRemoved_images,    $msgTmp] = $this->PurgeTable('#__rsg2_images', Text::_('COM_RSGALLERY2_PURGED_IMAGE_ENTRIES_FROM_DATABASE')) . '<br>';
				[$isRemoved_galleries, $msgTmp] = $this->PurgeTable('#__rsg2_galleries', Text::_('COM_RSGALLERY2_PURGED_GALLERIES_FROM_DATABASE')) . '<br>';
				...
				// J3x old tables
				[$isRemoved, $msgTmp] = $this->PurgeTable('#__rsgallery2_acl', Text::_('COM_RSGALLERY2_PURGED_TABLE_RSGALLERY2_ACL')) . '<br>';
				[$isRemoved, $msgTmp] = $this->PurgeTable('#__rsgallery2_files', Text::_('COM_RSGALLERY2_PURGED_IMAGE_ENTRIES_FROM_DATABASE')) . '<br>';
				//[$isRemoved, $msgTmp] = $this->PurgeTable('#__rsgallery2_cats', Text::_('COM_RSGALLERY2_PURGED_TABLE_RSGALLERY2_CATS')) . '<br>';
				[$isRemoved, $msgTmp] = $this->PurgeTable('#__rsgallery2_galleries', Text::_('COM_RSGALLERY2_PURGED_GALLERIES_FROM_DATABASE')) . '<br>';
				[$isRemoved, $msgTmp] = $this->PurgeTable('#__rsgallery2_config', Text::_('COM_RSGALLERY2_PURGED_TABLE_RSGALLERY2_CONFIG')) . '<br>';
				[$isRemoved, $msgTmp] = $this->PurgeTable('#__rsgallery2_comments', Text::_('COM_RSGALLERY2_PURGED_TABLE_RSGALLERY2_COMMENTS')) . '<br>';
			}
