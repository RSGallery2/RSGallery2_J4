...
class GalleryParams extends AbstractCommand
{
     ...
     * @var    string
     */
    protected static $defaultName = 'rsgallery2:gallery:parameters';
    ...
    protected function configure(): void
    {
        ...
        $help = "<info>%command.name%</info> display parameters of params field from table of selected gallery
  ...
  ";
        $this->setDescription(Text::_('List all variables in params field of selected gallery'));
        $this->setHelp($help);
    }
    ...
    protected function doExecute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->ioStyle->title('RSGallery2 Gallery Parameter Field');
