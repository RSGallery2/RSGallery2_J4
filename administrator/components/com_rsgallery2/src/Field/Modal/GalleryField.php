...
class GalleryField extends FormField
{
	...
	protected function getInput()
	{
		...
		// Load language.
		Factory::getLanguage()->load('com_rsgallery2', JPATH_ADMINISTRATOR);
		...
		$linkGalleries = 'index.php?option=com_rsgallery2&amp;view=galleries&amp;layout=modal&amp;tmpl=component&amp;' . Session::getFormToken() . '=1'
			. '&amp;extension=' . $extension;
		$linkGallery  = 'index.php?option=com_rsgallery2&amp;view=gallery&amp;layout=modal&amp;tmpl=component&amp;' . Session::getFormToken() . '=1'
			. '&amp;extension=' . $extension;
