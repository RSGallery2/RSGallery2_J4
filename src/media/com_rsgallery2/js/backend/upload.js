...
var RequestZipUploadTask = /** @class */ (function () {
    function RequestZipUploadTask(imagesAreaList, progressArea, errorZone, zipFiles, serverFiles, RequestTransferFolderFilesTask) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                _loop_4 = function () {
                    ...
                    nextFile.statusBar = new createStatusBar(this_3.progressArea, nextFile.file.name, nextFile.file.size, 'zip');
                    /* let request = */
                    //await this.callAjaxRequest(nextFile)
                    this_3.callAjaxRequest(nextFile)
                        ...
                        if (AjaxResponse.success) {
                            ...
                            for (var idx = 0; idx < foundFiles.files.length; idx++) {
                                ...
                                var statusBar = new createStatusBar(_this.progressArea, foundFile.baseName, foundFile.size, 'image');
                                //--- show image --------------------------------------
    ...
    // toDo: Html lib or similar
    RequestZipUploadTask.prototype.showThumb = function (responseData) {
        // Add HTML to show thumb of uploaded image
        // ToDo: images area class:span12 && #imagesAreaList class:thumbnails around ...
        //this.imageBox = $("<li></li>").appendTo($('#imagesAreaList'));
        var imageBox = document.createElement('li');
            ...
            return __generator(this, function (_a) {
                ...
                this.callAjaxRequest(this.serverFolder)
                    ...
                    if (AjaxResponse.success) {
                        ...
                        var foundFiles = AjaxResponse.data;
                        if (foundFiles.files.length > 0) {
                            _this.serverFolder.statusBar.setOK(true);
                            _this.serverFolder.statusBar.removeAbort();
                            _this.serverFolder.statusBar.setProgress(70);
                            // toDo: flag in response data for all loaded
                        ...
                        if (foundFiles.files.length > 0) {
                            _this.serverFolder.statusBar.setProgress(100);
                            _this.serverFolder.statusBar.setOK(true);
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    var requestZipUploadTask = new RequestZipUploadTask(elements.imagesAreaList, elements.progressArea, elements.errorZone, zipFiles, serverFiles, requestTransferFolderFilesTask);
