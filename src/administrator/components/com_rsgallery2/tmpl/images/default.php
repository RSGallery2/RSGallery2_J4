 ...
 */
/** @var \Rsgallery2\Component\Rsgallery2\Administrator\View\Images\HtmlView $this */
...
?>
<form action="<?php
echo Route::_('index.php?option=com_rsgallery2&view=images'); ?>"
                    ...
                    <table class="table" id="galleryList">
                        ...
                        <tr>
                            ...
                            <th scope="thumb" style="min-width:100px">
                                <?php
                                echo Text::_('COM_RSGALLERY2_IMAGE'); ?>
                            </th>

                            <th scope="col" style="min-width:100px">
                                <?php
                                echo HTMLHelper::_('searchtools.sort', 'COM_RSGALLERY2_TITLE', 'a.title', $listDirn, $listOrder); ?>
                            </th>
                            ...
                            <th scope="col" style="width:3%" class="text-center d-none d-md-table-cell">
                                <?php
                                echo HTMLHelper::_('searchtools.sort', 'COM_RSGALLERY2_GALLERY', 'gallery_name', $listDirn, $listOrder); ?>
                            </th>
...
//                                  $src = $this->ImagePathJ3x->getThumbUrl($item->name);
                            ...
                            >
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <?php
                                        echo HTMLHelper::_('jgrid.published', $item->published, $i, 'images.', $canChange); ?>
                                    </div>
                                </td>
                                ...
                                <td class="thumb" style="min-width:100px">
                                    <div class='imgContainer'>
                                        <img src="<?php
                                        echo $src; ?>" class="img-rounded modalActive" alt="<?php
                    ...
                    if ($user->authorise('core.create', $extension) && $user->authorise('core.edit', $extension) && $user->authorise('core.edit.state', $extension)) : ?>
                        <?php
                        echo HTMLHelper::_('bootstrap.renderModal', 'collapseModal', ['title' => Text::_('COM_RSGALLERY2_IMAGES_BATCH_OPTIONS'), 'footer' => $this->loadTemplate('batch_footer'),], $this->loadTemplate('batch_body')); ?>
                    <?php
                    endif; ?>
                <?php
                endif; ?>
