...
namespace Rsgallery2\Component\Rsgallery2\Administrator\Tmpl\Config;
...
// ToDo: should be checked in html
...
<form action="<?php echo Route::_('index.php?option=com_rsgallery2&view=config&layout=dbmanifestedit.php'); ?>"
...
//                ); ?>
                ...
                <p>
                <h3><?php echo Text::_('COM_RSGALLERY2_MANIFEST_MINUS_RAW_EDIT', true); ?> </h3></p>
                <legend><strong><?php echo Text::_('COM_RSGALLERY2_MANIFEST_RAW_EDIT_DESC'); ?></strong></legend>
                ...
                try {
                    /**/
                    foreach ($manifestVars as $name => $value) {
