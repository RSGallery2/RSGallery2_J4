...
class FormElements {
    ...
    btnTransferAllJ3xImjages: HTMLButtonElement;
    ...
    constructor() {
        ...
        this.btnTransferAllJ3xImjages = <HTMLButtonElement>document.getElementById('moveAllJ3xImjages');
...
//        formElements.btnTransferByGallery.onclick = onMoveByGallery();
        ...
        formElements.btnTransferByGallery.onclick = (ev) => this.onMoveByGallery(ev, formElements.selectGallery);
        formElements.btnTransferByCheckedGalleries.onclick = (ev) => this.onMoveByCheckedGalleries(ev);
        formElements.btnTransferAllJ3xImjages.onclick = (ev) => this.onMoveAllGalleries(ev);
