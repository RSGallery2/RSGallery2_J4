...
var J3xImages2Move = /** @class */ (function (_super) {
    __extends(J3xImages2Move, _super);
    function J3xImages2Move() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    J3xImages2Move.prototype.addImages = function (image_ids, gallery) {
...
var GalleriesListTask = /** @class */ (function () {
    ...
    formElements, j3xGalleries, requestImageIdsTask) {
        ...
        formElements.btnMoveByGallery.onclick = function (ev) { return _this.onMoveByGallery(ev, formElements.selectGallery); };
        formElements.btnMoveByCheckedGalleries.onclick = function (ev) { return _this.onMoveByCheckedGalleries(ev); };
        formElements.btnMoveAllJ3xImjages.onclick = function (ev) { return _this.onMoveAllGalleries(ev); };
                ...
                _loop_1 = function () {
                    ...
                    this_1.callAjaxRequest(j3xGallery)
                        ...
                        if (AjaxResponse.success) {
                            ...
                            _this.j3xImages2Move.addImages(image_ids, j3xGallery);
    ...
    MoveImagesTask.prototype.ajaxMove = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                _loop_3 = function () {
                    this_2.isBusyCount++;
                    var j3xImage = this_2.j3xImages2Move.shift();
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    var j3xImages2Move = new J3xImages2Move();
    ...
    var moveImagesTask = new MoveImagesTask(elements, j3xImages2Move);
    // (2) ajax request: database
    var requestImageIdsTask = new RequestImageIdsTask(elements, j3xGalleries, j3xImages2Move, moveImagesTask);
    //                                                   j3xGalleries, j3xImages2Move, moveImagesTask);
