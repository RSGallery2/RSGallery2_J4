 ...
 *
     * @since      5.1.0
 */
class Imagewallj3xModel extends GalleryModel
{
    /**
    ...
    public function AddLayoutData($images)
    {
        ...
        try {
            ...
            $OutTxt = '';
            $OutTxt .= 'Imagewallj3xModel: AddLayoutData: Error executing query: "' . "" . '"' . '<br>';
    ...
    public function AssignUrlImageAsInline($image, $idx)
    {
        try {
            ...
            $OutTxt = '';
            $OutTxt .= 'Imagewallj3xModel: AssignUrlImageAsInline: Error executing query: "' . "" . '"' . '<br>';
            $OutTxt .= 'Error: "' . $e->getMessage() . '"' . '<br>';
    ...
    public function assignSlideshowUrl($gallery)
    {
        try {
            ...
            $OutTxt = '';
            $OutTxt .= 'Imagewallj3xModel: assignSlideshowUrl: Error executing query: "' . "" . '"' . '<br>';
            $OutTxt .= 'Error: "' . $e->getMessage() . '"' . '<br>';
